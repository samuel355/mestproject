                            ...
                            <div className="col-md-10">
                                ...
                                <div className="row justify-content-center mb-4">
                                    <div className="col-md-10 text-center">
                                        <h1 data-aos="fade-up" class="mb-5"> Login</h1>
                                    </div>
                                </div>
                    ...
                    <div class="container">
                        ...
                        <div class="col-md-7 mb-5"  data-aos="fade">
                            ...
                            <form action="#" class="p-5 bg-white" style={{marginTop: '-150px'}}>
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <input type="submit" value="Login" class="btn btn-pill btn-primary btn-md text-white" />
                                    </div>
                                </div>

                                <p>
                                    <Link className="btn btn-primary btn-sm" to ="/Signup"> Don't have an Account ?</Link>
                                </p>
