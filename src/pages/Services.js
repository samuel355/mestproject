                    ...
                    <div className="container">
                        ...
                        <div className="col-md-10">
                            ...
                            <div className="col-md-10 text-center">
                                <h1 data-aos="fade-up" class="mb-5">We have the best  <span class="typed-words"></span></h1>
                    ...
                    <div className="container">
                        <div classNameName="row">
                            <div classNameName="col-md-12">
                                <h3 className="mb-3">What We Offer Our Customers</h3>
                        ...
                        <div className="row">
                            <div className="mb-4 mb-lg-0 col-sm-6 col-md-6 col-lg-3">
                                ...
                                <a href=" #" class="thumbnail-link d-block mb-4"><img src="images/img_1.jpg" alt=" " class="img-fluid" /></a>
                                <h3 className="block-service-1-heading mb-3"><a href=" #">Our History</a></h3>
                            ...
                            <div className="mb-4 mb-lg-0 col-sm-6 col-md-6 col-lg-3">
                                <div className="block-service-1-card">
                                <a href=" #" class="thumbnail-link d-block mb-4"><img src="images/img_2.jpg" alt=" " class="img-fluid" /></a>
                                <h3 className="block-service-1-heading mb-3"><a href=" #">Our Gallery</a></h3>
                                <div className="block-service-1-excerpt"><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Enim odit molestias inventore, id sed, in harum tenetur earum.</p></div>
                                <p><a href=" #" class="d-inline-flex align-items-center block-service-1-more"><span>Find out more</span> <span class="icon-keyboard_arrow_right icon"></span></a></p>
                                </div>
                            </div>
                            <div className="mb-4 mb-lg-0 col-sm-6 col-md-6 col-lg-3">
                                <div className="block-service-1-card">
                                <a href=" #" class="thumbnail-link d-block mb-4"><img src="images/img_3.jpg" alt="Im " class="img-fluid" /></a>
                                <h3 className="block-service-1-heading mb-3"><a href=" #">Our Practices</a></h3>
                                <div className="block-service-1-excerpt"><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Enim odit molestias inventore, id sed, in harum tenetur earum.</p></div>
                                <p><a href=" #" class="d-inline-flex align-items-center block-service-1-more"><span>Find out more</span> <span class="icon-keyboard_arrow_right icon"></span></a></p>
                                </div>
                            </div>
                    ...
                    <div className="block-half-content-text bg-primary">
                        ...
                        <div className="row">
                            ...
                            <div className="counter">
                                ...
                                <span className="block-counter-1-number" data-number="3">0</span><span class="append">K</span>
                                </div>
                            ...
                            <div className="counter">
                                <div className="number-wrap">
                                <span className="block-counter-1-number" data-number="7">0</span><span class="append"></span>
                                </div>
                            ...
                            <div className="counter">
                                <div className="number-wrap">
                                <span className="block-counter-1-number" data-number="100">0</span><span class="append">%</span>
                                </div>
                    ...
                    <div className="container">
                        ...
                        <div className="col-12">
                            ...
                            <div className="d-block block-testimony mx-auto text-center">
                                ...
                                <img src="images/person_1.jpg" alt="Imag" className="img-fluid rounded-circle w-50 mx-auto" />
                                </div>
                                <div>
                            ...
                            <div className="d-block block-testimony mx-auto text-center">
                                <div className="person w-25 mx-auto mb-4">
                                <img src="images/person_2.jpg" alt="Imag" className="img-fluid rounded-circle w-50 mx-auto" />
                                </div>
                                <div>
                            ...
                            <div className="d-block block-testimony mx-auto text-center">
                                <div className="person w-25 mx-auto mb-4">
                                <img src="images/person_3.jpg" alt="Imag" className="img-fluid rounded-circle w-50 mx-auto" />
                                </div>
                                <div>
                                <h2 className="h5 mb-4">Katie Johnson</h2>
                                <blockquote>&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias accusantium qui optio, possimus necessitatibus voluptate aliquam velit nostrum tempora ipsam!&rdquo;</blockquote>
                            ...
                            <div className="d-block block-testimony mx-auto text-center">
                                <div className="person w-25 mx-auto mb-4">
                                <img src="images/person_4.jpg" alt="Imag" className="img-fluid rounded-circle w-50 mx-auto" />
                                </div>
                                <div>
                                <h2 className="h5 mb-4">Jun Mars</h2>
                                <blockquote>&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias accusantium qui optio, possimus necessitatibus voluptate aliquam velit nostrum tempora ipsam!&rdquo;</blockquote>
