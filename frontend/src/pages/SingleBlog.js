                            ...
                            <div className="col-md-10">
                                ...
                                <div className="row justify-content-center mb-4">
                                    <div className="col-md-10 text-center">
                                        <h1>Wonderful Tore</h1>
                                        <p data-aos="fade-up" data-aos-delay="100">Posted by Admin <span class="mx-3">&bullet;</span> Jan 10th, 2021</p>
                                    </div>
                                </div>
                ...
                <div class="site-section">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <p class="mb-4"><img src="images/hero_bg_1.jpg" alt="Imag" class="img-fluid" /></p>
                                ...
                                <div class="pt-5">
                                    ...
                                    <ul class="comment-list">
                                        ...
                                        <li class="comment">
                                            <div class="vcard bio">
                                                <img src="images/comment_vcard.jpg" alt="Imag placeholder" />
                                            </div>
                                            <div class="comment-body">
                                                <h3>Jean Doe</h3>
                                                <div class="meta">January 9, 2018 at 2:21pm</div>
